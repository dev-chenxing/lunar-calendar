...
<template>
	...
	<main class="gap-2 py-2 text-2xl text-green">
		...
		<div class="grid grid-cols-3 p-1 *:flex *:items-center *:justify-center h-[19rem]">
			<div class="[writing-mode:vertical-rl] mr-auto text-xs"><ChinesePoetry/></div>
			<div class="font-bold text-[18rem] leading-none drop-shadow-green">{{ date }}</div>
			<div class="[writing-mode:vertical-lr] ml-auto">山河以秋</div>
		</div>
